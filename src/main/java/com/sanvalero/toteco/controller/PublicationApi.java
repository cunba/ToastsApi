...
public interface PublicationApi {
        ...
        public ResponseEntity<List<Publication>> getByEstablishment(
                        @Parameter(description = "Establishment ID", required = true) @PathVariable("id") UUID id)
                        throws NotFoundException;

        @Operation(summary = "Get publication by user", operationId = "getByUser")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "OK"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
        ...
        @Operation(summary = "Get publication by ID", operationId = "getById")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "OK"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
        ...
        @SecurityRequirements
        @SecurityRequirement(name = "bearer")
        public ResponseEntity<Publication> getById(
                        @Parameter(description = "Publication ID", required = true) @PathVariable("id") UUID id)
                        throws NotFoundException;

        @Operation(summary = "Get all publications", operationId = "getAll")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "OK"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "500", description = "Internal server error", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
        ...
        @Secured({ "ROLE_ADMIN" })
        @Operation(summary = "Save publication", operationId = "save")
        @ApiResponses(value = {
        ...
        @SecurityRequirements
        @SecurityRequirement(name = "bearer")
        public ResponseEntity<Publication> save(
                        @Parameter(description = "Publication transfer object", required = true) @RequestBody PublicationDTO publicationDTO)
                        throws NotFoundException;

        @Secured({ "ROLE_ADMIN" })
        @Operation(summary = "Update publication", operationId = "update")
        @ApiResponses(value = {
        ...
        public ResponseEntity<HandledResponse> update(
                        @Parameter(description = "Publication ID", required = true) @PathVariable UUID id,
                        @Parameter(description = "Publication transfer object", required = true) @RequestBody PublicationDTO publicationDTO)
                        throws NotFoundException;

        @Secured({ "ROLE_ADMIN" })
        @Operation(summary = "Delete publication", operationId = "delete")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "OK"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Publication not found", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
        ...
        @SecurityRequirements
        @SecurityRequirement(name = "bearer")
        public ResponseEntity<Publication> delete(
                        @Parameter(description = "Publication ID", required = true) @PathVariable UUID id)
                        throws NotFoundException;

        @Secured({ "ROLE_ADMIN" })
        @Operation(summary = "Delete all publications", operationId = "deleteAll")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "OK"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "500", description = "Internal server error", content = @Content(schema = @Schema(implementation = ErrorResponse.class))) })
